...
public class VM {
	...
	public void call(FuncMetaData metadata) {
		int nargs = metadata.nargs;	// how many args got pushed
		int nlocals = metadata.nlocals;
		...
		sp -= nargs;
		ip = metadata.address;		// jump to function
	}
