...
public class Bytecode {
	...
	public static final short FUNCIDX = 18; // push function pointer
	public static final short CALLIDX = 19; // call function using pointer on stack; push args then func index

	public static final short HALT = 20;
	...
	public static Instruction[] instructions = new Instruction[] {
		...
		new Instruction("ret"),
		new Instruction("funcidx", 1),
		new Instruction("callidx"),
