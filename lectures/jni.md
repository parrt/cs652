...
The basic idea is that the Java code specifies the Java interface part without a body by using the `native` keyword. Then, the `javah` tool creates an include file with all of the appropriate definitions for C code to define the appropriate native method(s).
...
$ cc -dynamiclib -o libhello.jnilib \
  ...
  hello.c
$ ls
HelloJNI.class   HelloJNI.h       HelloJNI.java    hello.c          libhello.jnilib*
$ java HelloJNI
Hello World!
```
...
we get this include file from `javah GetTime`:
...
This lets us link to our C code:
...
$ javac GetTime.java 
$ ls
$ GetTime.class  GetTime.java   gettime.c
$ javah GetTime
$ ls
GetTime.class  GetTime.h      GetTime.java   gettime.c
$ cc -dynamiclib -o libgettime.jnilib \
  -I/Library/Java/JavaVirtualMachines/jdk1.8.0.jdk/Contents/Home/include \
  -I/Library/Java/JavaVirtualMachines/jdk1.8.0.jdk/Contents/Home/include/darwin \
  gettime.c
$ ls
GetTime.class      GetTime.h          GetTime.java       gettime.c          libgettime.jnilib*
$ java GetTime
The current time is: 11:11:19.
```
...
We cannot use just plain `a[i]` in C; must use `GetArrayLength`, `GetIntArrayElements`, and `ReleaseIntArrayElements`:
...
$ javah SumArray
$ ls
SumArray.class  SumArray.h      SumArray.java   sum.c
$ cc -dynamiclib -o libsum.jnilib \
   -I/Library/Java/JavaVirtualMachines/jdk1.8.0.jdk/Contents/Home/include \
   -I/Library/Java/JavaVirtualMachines/jdk1.8.0.jdk/Contents/Home/include/darwin \
   sum.c
$ ls
SumArray.class  SumArray.h      SumArray.java   libsum.jnilib*  sum.c
$ java SumArray
sum = 45
```
