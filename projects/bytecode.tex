...
\begin{tikzpicture}
  \small  \cell{$\text{\em f:pass:}^{block_1}[\_,,5]$}
  \cell{$\text{\em f:pass:}^{block_2}[\_,,]$}
  \cell{$~~~~\text{\em f:pass:}[\_,\text{\em f:pass:}^{block_1}\,2\,nil,]~~~~$}\cellptr{$2^{nd}$ call to {\em f:pass:}}
  \cell{$g[\_,\text{\em f:pass:}^{block_1},]$}
  \cell{$\text{\em f:pass:}^{block_0}[\_,f^{block_0},]$}
  \cell{$\text{\em f:pass:}[\_,nil\,1\,5,]$} \cellptr{$1^{st}$ call to {\em f:pass:}}
  \cell{$main[\_,,]$}
\end{tikzpicture}
{\em Notes}:
\end{minipage} \\
